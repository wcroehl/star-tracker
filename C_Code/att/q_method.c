int q_method(t, q, P, nstar, dist_index, out1a, out2, outPT2, outPT3, OW_qtest, OV_qtest, On_qtest)
FILE   *out1a, *out2, *outPT2, *outPT3, *OW_qtest, *OV_qtest;
int    nstar ;
double t, q[4], P[3][3], *dist_index ;
{
    int    i, j, k, IFAIL, Test0 ;      
    ...
    *dist_index = 0.0 ;
    ...
    /*if statement for qtest*/
    fprintf(On_qtest, "%15.6d \n", nstar);
    if (nstar == 4){
         fprintf(OW_qtest, "%20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n", W[0][0], \
                 W[0][1], W[0][2], W[0][3], t, W[1][0], W[1][1], W[1][2], W[1][3], Test0, \
                 W[2][0], W[2][1], W[2][2], W[2][3], Test0, W[3][0], W[3][1], W[3][2], W[3][3], Test0);
          fprintf(OV_qtest, "%20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n", V[0][0], \
                 V[0][1], V[0][2], V[0][3], t, V[1][0], V[1][1], V[1][2], V[1][3], Test0, \
                 V[2][0], V[2][1], V[2][2], V[2][3], Test0, V[3][0], V[3][1], V[3][2], V[3][3], Test0);
    }
    else if (nstar == 5){
         fprintf(OW_qtest, "%20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n", W[0][0], \
                 W[0][1], W[0][2], W[0][3], t, W[1][0], W[1][1], W[1][2], W[1][3], Test0, \
                 W[2][0], W[2][1], W[2][2], W[2][3], Test0, W[3][0], W[3][1], W[3][2], W[3][3], Test0, \
                 W[4][0], W[4][1], W[4][2], W[4][3], Test0);
          fprintf(OV_qtest, "%20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n", V[0][0], \
                 V[0][1], V[0][2], V[0][3], t, V[1][0], V[1][1], V[1][2], V[1][3], Test0, \
                 V[2][0], V[2][1], V[2][2], V[2][3], Test0, V[3][0], V[3][1], V[3][2], V[3][3], Test0, \
                 V[4][0], V[4][1], V[4][2], V[4][3], Test0);           
    }
    else {
         fprintf(OW_qtest, "%20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n", W[0][0], \
                 W[0][1], W[0][2], W[0][3], t, W[1][0], W[1][1], W[1][2], W[1][3], Test0, \
                 W[2][0], W[2][1], W[2][2], W[2][3], Test0, W[3][0], W[3][1], W[3][2], W[3][3], Test0, \
                 W[4][0], W[4][1], W[4][2], W[4][3], Test0, W[5][0], W[5][1], W[5][2], W[5][3], Test0);
         fprintf(OV_qtest, "%20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n %20.15f %20.15f %20.15f %20.15f %20.15f\n", V[0][0], \
                 V[0][1], V[0][2], V[0][3], t, V[1][0], V[1][1], V[1][2], V[1][3], Test0, \
                 V[2][0], V[2][1], V[2][2], V[2][3],Test0, V[3][0], V[3][1], V[3][2], V[3][3], Test0, \
                 V[4][0], V[4][1], V[4][2], V[4][3], Test0, V[5][0], V[5][1], V[5][2], V[5][3], Test0);           
    }
