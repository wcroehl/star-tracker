...
while( ccd_time <= TIMELIMIT ) 
    ...
    if ( ccd_time < cctime && nstar >= 3)
        ...
        [ccd_time, cnt ,m_star, BLI, NEWBLI, rtn, b_star, crf, nstar] = starID_pm(ccd_time, q0, nstar, cnt, bore_body, outi, outr, outo, outmag, ixy, x, y, xmag, adjcell, scell, stars, m_star);        
    ...
    if (cnt >= 3)
        ...
        %[qq, P, d_i, rtn] = q_method(W, V, nstar, d_i);
