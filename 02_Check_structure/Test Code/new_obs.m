...
%         vec_dot, arc_dist ;
 ...
 i=1;
 while ((fabs(ra_diff_BD) < BD_limit*3600+1800.) || ...
         ((fabs(ra_diff_new) < FOV_limit*3600+1800.) &&  i < floor(scell2(N_zone-1).num_stars/2.0)))
     ...
     ra_diff_new = ra_diff * cos(new_dec*PI/180.0) * 3600.0 ;
     ra_diff_BD = rad_diff_BD * cos(  BD_dec*PI/180.0) * 3600.0 ;
  ...
  while(((fabs(ra_diff_BD) < BD_limit*3600+1800.) || (fabs(ra_diff_new) < FOV_limit*3600+1800.))... 
