function return_value = dmt_write(t, id_count, id_star, id_body, outmag, outo, outi, outr, ixy, x, y, xmag, stars)
...
for(i=1:id_count)
   ...
   fprintf(outo,"%15.6f  %20.15f %20.15f %20.15f %10.2f\n", t, m_star((id_body+i)).L(1), m_star((id_body+i)).L(2),m_star((id_body+i)).L(3), m_star((id_body+i)).mag) ;
