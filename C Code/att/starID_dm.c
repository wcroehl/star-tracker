starID_dm(t, q0, nstar, id_count, cctime, w, crf_count, id_star, id_body, 
          outi, outr, outo, outmag, outdist, ixy, x, y, xmag, outMpC, t_start, t_end)
FILE   *outi, *outr, *outo,  *outmag, *outdist, *ixy, *outMpC ;
...
{  
   ...
   dmt_atti(w, q0, Mp) ;
   fprintf(outMpC, "%20.15f %20.15f %20.15f \n%20.15f %20.15f %20.15f \n% 20.15f %20.15f %20.15f \n \n", Mp[0][0], Mp[0][1], Mp[0][2], Mp[1][0], Mp[1][1], \
            Mp[1][2], Mp[2][0], Mp[2][1], Mp[2][2]);
